# tax-doc-sdk-tax1099r

Software development kit to generate IRS Form 1099-R as PDF file using Financial Data Exchange (FDX) standards including QR codes and embedded JSON.

<img alt="Sample Form" src="samples/Tax1099R.sample.png" width="850"/>

...
import irs.fdxtax640.jsonserializers.Tax1099RSerializer;
import irs.fdxtax640.jsonserializers.TaxStatementListSerializer;
import irs.fdxtax640.map2objects.Map2Tax1099R;
import irs.fdxtax640.obj2mappers.TaxStatementList2Map;

import org.apache.commons.lang3.time.StopWatch;
import org.taxdataexchange.core.pdfbuilders.Tax1099RPdfBuilder;
...
public class Tax1099RDocumentGenerator {
    ...
    private void processOneRow(
        ...
        Tax1099R obj = Map2Tax1099R.generate( row );
        {
            String asJson = Tax1099RSerializer.serialize( obj );
    ...
    private void processCsvForCompany(
        ...
        // CSV file
        String csvFileName  = "Tax1099R.csv";
        ...
        String outputFileName = "Tax1099R.rows.json";
    ...
    public static void main(String[] args) {
        ...
        Tax1099RDocumentGenerator generator = new Tax1099RDocumentGenerator( );
